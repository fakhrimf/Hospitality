 ...
 * Use the [ConfirmRegistrationFragment.newInstance] factory method to
...
class ConfirmRegistrationFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ConfirmRegistrationFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ConfirmRegistrationFragment().apply {
